...
"""Async WebSocket connection implementation for Azure AI VoiceLive."""

from __future__ import annotations

import json
import logging
from typing import AsyncIterator, Any, cast, Optional, Union
...
class VoiceLiveConnection:
    ...
    :type connection: websockets.asyncio.client.ClientConnection
    """
    ...
    async def __aiter__(self) -> AsyncIterator[Any]:
        """Return an async iterator over server events.
