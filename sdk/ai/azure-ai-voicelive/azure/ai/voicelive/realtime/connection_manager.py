...
"""WebSocket connection manager implementation for Azure AI VoiceLive."""
...
class VoiceLiveConnectionManager:
    """Connection manager for VoiceLiveConnection.
    ...
    :type client: azure.ai.voicelive.VoiceLiveClient
    ...
    def __enter__(self) -> VoiceLiveConnection:
        ...
        self.__connection = VoiceLiveConnection(
            connect(
                str(url),
                additional_headers={
                    **self.__client._auth_headers,  # pylint: disable=protected-access
    ...
    # Alias for enter that can be called directly
    enter = __enter__
